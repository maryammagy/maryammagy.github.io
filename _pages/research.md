...
>>>
>>>
**Fractional order systems.** In this project that I did while I was at University of Notre Dame, I worked on a (non artificial intelligent) control problem for [fractional order systems](https://en.wikipedia.org/wiki/Fractional-order_system). Because of their complex dynamics, controlling these systems is very challenging. There are two very powerful tools in nonlinear control theory, namely passivity and dissipativity, that are very useful in controlling nonlinear systems. However, these two tools were missing for the fractional order systems. I proposed the framework of passivity and dissipativity for the fractional order systems and showed that the existing tools in nonlinear control theory are a special case of the passivity and dissipativity in fractional order systems. You can read more about it in [SIAM Journal on Control and Optimization](https://epubs.siam.org/doi/abs/10.1137/17M1126230).
In another project in collaboration with amazing researchers from University of Michigan-Shanghai Jiao Tong University Joint Institute in China, Aarhus University in Denmark, Omron Adept Technologies in USA, and Shiraz University in Iran, we worked on the problem of robotic manipulator control using artificial intelligence. Robotic manipulator control is a challenging task due to its nonlinear, interacting multi-input–multi-output dynamics. We proposed an optimal robust fractional-order fuzzy PID controller based on multi-objective particle swarm optimization (MOPSO) algorithm and used the software-in-the-loop real-time simulation to show the effectiveness our method in controlling the robotic manipulator. You can read more it in [Soft Computing](https://link.springer.com/article/10.1007/s00500-019-04152-7).
>>>
